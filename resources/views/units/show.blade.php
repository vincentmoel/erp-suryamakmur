...
@section('content')
    <div class="page-content">
        ...
        <div class="page-header">
            <h1>@lang('general.unit_detail')</h1>
            <p>@lang('general.unit_detail_desc')</p>
        </div>
        ...
        <div class="rounded-lg border bg-card text-card-foreground shadow-xs">
            ...
            <div class="flex items-center gap-3 border-b px-6 py-4">
                ...
                <h3 class="text-sm font-semibold">@lang('general.unit_information')</h3>
            </div>
            ...
            <div class="grid grid-cols-1 gap-0 divide-y sm:grid-cols-2 sm:divide-y-0 sm:divide-x">
                ...
                <div class="flex flex-col gap-1 px-6 py-4">
                    <span class="text-xs font-medium text-muted-foreground uppercase tracking-wide">@lang('general.abbreviation')</span>
