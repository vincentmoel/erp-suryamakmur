@extends('layouts.main', ['title' => __('general.add_bill')])

@section('content')
    <div class="page-content">

        <div class="page-header">
            <h1>@lang('general.add_bill')</h1>
            <p>@lang('general.add_bill_desc')</p>
        </div>
                ...
                <div class="flex flex-col items-end gap-2 border-t px-6 py-4">
                    ...
                    <div class="flex items-center gap-4 text-sm w-full justify-end mt-2">
                        ...
                        <div class="w-44 shrink-0">
                            ...
                            <input type="hidden" name="discount_percent" id="pur-discount-pct" value="{{ old('discount_percent') }}">
                    ...
                    <div class="flex items-center gap-4 text-sm w-full justify-end">
                        ...
                        <div class="w-44 shrink-0">
                            ...
                            <input type="hidden" name="tax_percent" id="pur-tax-pct" value="{{ old('tax_percent') }}">
                            <input type="hidden" name="tax_amount" id="pur-tax" value="{{ old('tax_amount') }}">
                        </div>
                    </div>
