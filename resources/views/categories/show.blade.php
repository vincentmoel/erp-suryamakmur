...
@section('content')
    <div class="page-content">
        ...
        <div class="page-header">
            <h1>@lang('general.category_detail')</h1>
            <p>@lang('general.category_detail_desc')</p>
        </div>
        ...
        <div class="rounded-lg border bg-card text-card-foreground shadow-xs">
            ...
            <div class="flex items-center gap-3 border-b px-6 py-4">
                <div class="flex size-8 items-center justify-center rounded-md bg-primary/10">
                    <x-icon name="tag" class="size-4 text-primary" />
                </div>
                <h3 class="text-sm font-semibold">@lang('general.category_information')</h3>
            </div>
            ...
            <div class="flex gap-2 border-t px-6 py-4">
                <a href="{{ route('categories.edit', ['encryptedId' => $encryptedId]) }}"
