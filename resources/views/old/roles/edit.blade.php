@extends('layouts.main', [
    "title" => "Edit Role",
    "breadcrumbs" => [
        ['title' => 'Roles', 'link' => route('roles.index')],
        ['title' => 'Edit Role'],
    ]
])
...
@section('content')
    <div class="card">
        <form action="{{ route('roles.update', ['encryptedId' => \App\Helpers\Encryption::encrypt($role['id'])]) }}" method="POST">
            @csrf
            @method("PATCH")
            <div class="card-body">
                            ...
                            <table class="text-center table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($modules as $moduleKey => $moduleValue)
                                        @php
                                            $currentPermissionModule = $role->permissions->where('module', $moduleKey)->first();
                                        @endphp
                                        <tr>
                                            <td>
                                                {{ $moduleValue }}
                                            ...
                                            <td>
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    {{ in_array(old("permission.".$moduleKey.".menu", $currentPermissionModule->menu ?? 0), ['on', 1]) ? 'checked' : '' }}>
                                            ...
                                            <td>
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    {{ in_array(old("permission.".$moduleKey.".create", $currentPermissionModule->create ?? 0), ['on', 1]) ? 'checked' : '' }}>
                                                <label class="form-check-label"
                                            ...
                                            <td>
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    {{ in_array(old("permission.".$moduleKey.".read", $currentPermissionModule->read ?? 0), ['on', 1]) ? 'checked' : '' }}>
                                                <label class="form-check-label"
                                            ...
                                            <td>
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    {{ in_array(old("permission.".$moduleKey.".update", $currentPermissionModule->update ?? 0), ['on', 1]) ? 'checked' : '' }}>
                                                <label class="form-check-label"
                                            ...
                                            <td>
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    {{ in_array(old("permission.".$moduleKey.".delete", $currentPermissionModule->delete ?? 0), ['on', 1]) ? 'checked' : '' }}>
                                                <label class="form-check-label"
                                            ...
                                            <td>
                                                <input type="checkbox" class="form-check-input"
                                                    ...
                                                    {{ in_array(old("permission.".$moduleKey.".restore", $currentPermissionModule->restore ?? 0), ['on', 1]) ? 'checked' : '' }}>
                                                <label class="form-check-label"
