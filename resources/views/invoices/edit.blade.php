@extends('layouts.main', ['title' => __('general.edit_invoice')])

@section('content')
    <div class="page-content">

        <div class="page-header">
            <h1>@lang('general.edit_invoice')</h1>
            <p>{{ $data->code }}</p>
        </div>
                ...
                <div class="flex flex-col items-end gap-2 border-t px-6 py-4">
                    ...
                    <div class="flex items-center gap-4 text-sm w-full justify-end mt-2">
                        ...
                        <div class="w-44 shrink-0">
                            ...
                            <input type="hidden" name="discount_percent" id="inv-discount-pct" value="{{ old('discount_percent', $data->discount_percent) }}">
                    ...
                    <div class="flex items-center gap-4 text-sm w-full justify-end">
                        ...
                        <div class="w-44 shrink-0">
                            ...
                            <input type="hidden" name="tax_percent" id="inv-tax-pct" value="{{ old('tax_percent', $data->tax_percent) }}">
...
(function () {
    ...
    function addRow(data) {
        ...
        // Re-fetch unit info when restoring from old() or existing data — price already restored
